...
const styles = {
  ...
  imageCircle: {
    position: "absolute",
    width: { xs: "0px", md: "60px" },
    height: { xs: "0px", md: "60px" },
    borderRadius: "50%",
    overflow: "hidden",
  },
};
    ...
    <Box>
      <Box sx={styles.MainBox}>
        ...
        <Box sx={styles.middleBox}>
          ...
          voluptas aspernatur aut odit aut fugit, sed beatae vitae dicta
          adipiscing elit, sed do euismod tempor incidunt. Labore et dolore
