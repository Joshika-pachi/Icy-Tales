...
//     fontWeight: 500,
//     color: "#FFFFFF",
//     fontSize: { xs: "48px", sm: "76px", md: "92px" },
//     lineHeight: { xs: "55px", sm: "75px", md: "110px" },
...
//         </Box>
//         <Box sx={{paddingTop:"3%"}}>
//         <Button text={'Claim Offer'} width={180} height={62} bcolor={ColorPalette.pink} onClick={'#'}></Button>
//         </Box>
